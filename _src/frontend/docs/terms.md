# Termos de Uso e Política de Responsabilidade - Wissen-Wasser

**Versão 1.1 - Atualizado em 25 de Janeiro de 2026**

Ao utilizar o ecossistema Wissen-Wasser (incluindo o editor, o armazenamento local e a sincronização remota via JSONBin.io), você declara estar ciente e de acordo com as seguintes diretrizes:

---

## 1. Natureza do Serviço
O Wissen-Wasser é uma ferramenta de escrita minimalista fornecida "como está" (*as is*). O desenvolvedor não garante disponibilidade perpétua dos dados ou do serviço, visto que depende de infraestruturas de terceiros (Render, JSONBin.io, etc.).
...
* O desenvolvedor reserva-se o direito de excluir, sem aviso prévio, qualquer conteúdo que seja identificado como abusivo ou que comprometa a estabilidade técnica da infraestrutura, podendo banir o IP de usar o site.

## 5. Propriedade Intelectual
O conteúdo escrito pertence inteiramente ao autor. O Wissen-Wasser não reivindica qualquer direito sobre os textos produzidos através da plataforma.

---
*Escrito com transparência. Use com sabedoria e responsabilidade.*